 ...
 */
static inline void __debug_hex_byte(WT_DBG *ds, uint8_t v)
{
 ...
 */
static void __dmsg_wrapup(WT_DBG *ds)
{
 ...
 *	Debug message.
 */
static void __dmsg(WT_DBG *ds, const char *fmt, ...)
{
	va_list ap;
	WT_ITEM *msg;
	WT_SESSION_IMPL *session;
 ...
 */
static void __debug_dsk_col_fix(WT_DBG *ds, const WT_PAGE_HEADER *dsk)
{
	WT_BTREE *btree;
	uint32_t i;
	uint8_t v;
 ...
 */
static char * __debug_tree_shape_info(WT_PAGE *page)
{
	uint64_t v;
	static char buf[32];
 ...
 */
static void __debug_tree_shape_worker(WT_DBG *ds, WT_PAGE *page, int level)
{
	WT_REF *ref;
	WT_SESSION_IMPL *session;
 ...
 */
int __wt_debug_tree_all(WT_SESSION_IMPL *session, WT_PAGE *page, const char *ofile)
{
	return (__debug_tree(
 ...
 */
int __wt_debug_tree(WT_SESSION_IMPL *session, WT_PAGE *page, const char *ofile)
{
 ...
 */
int __wt_debug_page(WT_SESSION_IMPL *session, WT_PAGE *page, const char *ofile)
{
	WT_DBG *ds, _ds;
	WT_DECL_RET;
 ...
 */
static int __debug_tree(WT_SESSION_IMPL *session, WT_PAGE *page, const char *ofile, uint32_t flags)
{
	WT_DBG *ds, _ds;
	WT_DECL_RET;
 ...
 */
static int __debug_page(WT_DBG *ds, WT_PAGE *page, uint32_t flags)
{
	WT_DECL_RET;
	WT_SESSION_IMPL *session;
 ...
 */
static int __debug_page_metadata(WT_DBG *ds, WT_PAGE *page)
{
 ...
 */
static void __debug_page_col_fix(WT_DBG *ds, WT_PAGE *page)
{
	WT_BTREE *btree;
	WT_INSERT *ins;
 ...
 */
static int __debug_page_col_var(WT_DBG *ds, WT_PAGE *page)
{
	WT_CELL *cell;
	WT_CELL_UNPACK *unpack, _unpack;
	WT_COL *cip;
 ...
 */
static void __debug_col_skip(WT_DBG *ds, WT_INSERT_HEAD *head, const char *tag, int hexbyte)
{
	WT_INSERT *ins;
 ...
 *	Dump an insert list.
 */
static void __debug_row_skip(WT_DBG *ds, WT_INSERT_HEAD *head)
{
	WT_INSERT *ins;
 ...
 *	Dump an update list.
 */
static void __debug_update(WT_DBG *ds, WT_UPDATE *upd, int hexbyte)
{
 ...
 */
static int __debug_cell_data(WT_DBG *ds,
 ...
 */
static void __debug_item(WT_DBG *ds, const char *tag, const void *data_arg, size_t size)
{
	size_t i;
	int ch;
	const uint8_t *data;
